...
class TaskDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //                       children: taskController.members
    ...
    //                 Text(
    //                   'Description:',
    //                   style: TextStyle(fontSize: 16, color: dark? CColors.darkerGrey: Colors.grey),
    //                 ),
    //                 Text(
    //                   task.description,
    //                   style: TextStyle(
    //                       fontSize: 16, color: dark ? Colors.white : CColors.dark),
    //                 ),
    //                 SizedBox(height: 16),
    //                 Text(
    ...
    //                     height: 40,
    //                     width: 100,
    //                     color: taskController.groupTasks.any((task) => task.id == task.id && task.isCompleted)
    //                         ? Colors.green
    //                         : dark
    //                         ? CColors.grey.withOpacity(0.4)
    //                         : CColors.darkGrey,
    //                     label: taskController.groupTasks.any((task) => task.id == task.id && task.isCompleted)
    //                         ? "Done"
    //                         : "Doing",
    //                     onTap: () async {
    //                       await taskController.updateTaskCompletion(task.id, !task.isCompleted);
    //                     },
    //                   ),
    //                 )),
    //                 SizedBox(
