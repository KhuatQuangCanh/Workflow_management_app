...
class EditGroupScreen extends StatelessWidget {
  ...
  EditGroupScreen({required this.group}) {
    ...
    groupController.formattedStartTime.value =
        groupController.formatDateTime(group.startTime);
    groupController.formattedEndTime.value =
        groupController.formatDateTime(group.endTime);
  }
                        ...
                        Obx(() {
                          return Column(
                            ...
                            children: [
                              TextButton(
                                onPressed: () =>
                                    groupController.pickStartTime(context),
                                child: Text(
                              ...
                              TextButton(
                                onPressed: () =>
                                    groupController.pickEndTime(context),
                                child: Text(
